...
def build_schema(mysql_db, mysql_table_name, primary_key_name):
    # Create schema
    ...
    for field_name_mysql, field_type in zip(field_list, type_list):
        ...
        field_name = config.columns_map[field_name_mysql]
        ...
        if field_name == config.columns_map[primary_key_name]:
