...
llm_qwen_14B = ChatOpenAI(model="text2sql2",  
                    ...
                    base_url='http://10.218.1.3:8011/v1',  
                    api_key='EMPTY',
                    temperature=0,
                    )
...
llm_qwen_7B = ChatOpenAI(model="Qwen2.5-7B-Instruct",  
                    ...
                    base_url='http://10.218.1.3:8012/v1', 
                    api_key='EMPTY',
                    temperature=0,
                    )

openai_api_key_emb = "EMPTY"
openai_api_base_emb = 'http://10.218.1.3:8049/v1'  #  'http://172.31.24.23:8002/v1' # 'http://192.168.0.11:8076/v1' 
